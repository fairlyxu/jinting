        ...
        ajax.request = function (options) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                    ...
                    /**  
                     * changed by Shanyu01 2015/05/11
                     * save lastModified and eTag
                     */
                    /**modified = fakeXHR.getResponseHeader("Last-Modified");
                    var ER_MODIFIED = window.ER_MODIFIED || (window.ER_MODIFIED = {
                        modified: {},
                        etag: {}
                    });
                    if (modified) {
                        ER_MODIFIED.modified[options.url] = modified;
                    }
                    modified = fakeXHR.getResponseHeader("etag");
                    if (modified) {
                        ER_MODIFIED.etag[options.url] = modified;
                    }**/
            ...
            /** added by Shanyu01 2015/05/11 **/
            /**var ER_MODIFIED = window.ER_MODIFIED || null;
            if (ER_MODIFIED) {
                if (ER_MODIFIED.modified[options.url]) {
                    xhr.setRequestHeader("If-Modified-Since", ER_MODIFIED.modified[options.url]);
                }
                if (ER_MODIFIED.etag[options.url]) {
                    xhr.setRequestHeader("If-None-Match", ER_MODIFIED.etag[options.url]);
                }
            }**/
